using Simt.Api.App.EndToEndTests.Common;
...
void ConfigureDependencies(IServiceCollection serviceCollection)
{
    ...
    if (IsTesting())
    {
        serviceCollection.AddSingleton<IDALInstaller, DALTestInstaller>();
    }
    else
    {
...
bool IsTesting()
{
    return Environment.GetEnvironmentVariable("ASPNETCORE_TESTING") == "true";
}
